...
public class TelnetHelper {
	...
	public TelnetHelper(String hostname, int hostport, String user, String password) throws SocketException,
			IOException {
		super();
	...
	class ReadThread extends Thread {
		public void run() {
			synchronized (lock) {// 只能一个读取
				...
				try {
					System.out.println(new String(s.getBytes(ORIG_CODEC), TRANSLATE_CODEC));
